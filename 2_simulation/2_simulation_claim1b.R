...
df_all_counterfactuals_alpha1_07_alpha2_09_case1 <-
  map_dfr(data.frame(
    ...
    "alpha==0.90, VE_inf==0"   = c(0.90, 0),
    "alpha==0.90, VE_inf==0.1" = c(0.90, 0.1),
    "alpha==0.90, VE_inf==0.2" = c(0.90, 0.2),
    "alpha==0.90, VE_inf==0.3" = c(0.90, 0.3),
    "alpha==0.90, VE_inf==0.4" = c(0.90, 0.4),
    "alpha==0.90, VE_inf==0.5" = c(0.90, 0.5),
    "alpha==0.90, VE_inf==0.6" = c(0.90, 0.6),
    "alpha==0.90, VE_inf==0.7" = c(0.90, 0.7),
    "alpha==0.90, VE_inf==0.8" = c(0.90, 0.8),
    "alpha==0.90, VE_inf==0.9" = c(0.90, 0.9),
    "alpha==0.90, VE_inf==1.0" = c(0.90, 1.0)
  ), function(par) {
...
df_all_counterfactuals_alpha1_07_alpha2_09_case1 <- collapse_vax_status(df_all_counterfactuals_alpha1_07_alpha2_09_case1)
...
df_all_counterfactuals_alpha1_07_alpha2_09_case2 <-
  map_dfr(data.frame(
    "alpha==0.70, VE_inf==0" = c(0.70, 0),
    "alpha==0.70, VE_inf==0.1" = c(0.70, 0.1),
    "alpha==0.70, VE_inf==0.2" = c(0.70, 0.2),
...
df_all_counterfactuals_alpha1_07_alpha2_09_case2 <- collapse_vax_status(df_all_counterfactuals_alpha1_07_alpha2_09_case2)

# (3) Case 3: Increasing IFR (mu) ----------------------------------------------
case3_generator <- odin::odin("~/Documents/GitHub/population_level_effects/1_model/case3_inc_mu.R")
df_all_counterfactuals_alpha1_07_alpha2_09_case3 <-
  map_dfr(data.frame(
    "alpha==0.70, VE_inf==0" = c(0.70, 0),
    "alpha==0.70, VE_inf==0.1" = c(0.70, 0.1),
    "alpha==0.70, VE_inf==0.2" = c(0.70, 0.2),
...
df_all_counterfactuals_alpha1_07_alpha2_09_case3 <- collapse_vax_status(df_all_counterfactuals_alpha1_07_alpha2_09_case3)

# (4) Case 4: Waning VEs ------------------------------------------------------------
case4_generator <- odin::odin("~/Documents/GitHub/population_level_effects/1_model/case4_waning_VEs.R")
df_all_counterfactuals_alpha1_07_alpha2_09_case4 <-
  map_dfr(data.frame(
    "alpha==0.70, VE_inf==0" = c(0.70, 0),
    "alpha==0.70, VE_inf==0.1" = c(0.70, 0.1),
    "alpha==0.70, VE_inf==0.2" = c(0.70, 0.2),
...
df_all_counterfactuals_alpha1_07_alpha2_09_case4 <- collapse_vax_status(df_all_counterfactuals_alpha1_07_alpha2_09_case4)
...
df_all_counterfactuals_alpha1_07_alpha2_09_case5 <-
  map_dfr(data.frame(
    "alpha==0.70, VE_inf==0" = c(0.70, 0),
    "alpha==0.70, VE_inf==0.1" = c(0.70, 0.1),
    "alpha==0.70, VE_inf==0.2" = c(0.70, 0.2),
...
df_all_counterfactuals_alpha1_07_alpha2_09_case5 <- collapse_vax_status(df_all_counterfactuals_alpha1_07_alpha2_09_case5)
